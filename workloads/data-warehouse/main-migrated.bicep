...
param dbAdminUsername string = 'sqladmin'
...
param cosmosSubnetPrefix string = '10.0.3.0/24'

@description('Synapse subnet prefix')
param synapseSubnetPrefix string = '10.0.4.0/24'

@description('Services subnet prefix')
param servicesSubnetPrefix string = '10.0.5.0/24'

@description('Gateway subnet prefix')
param gatewaySubnetPrefix string = '10.0.6.0/24'
